...
List<ServicesModel> getServices() {
  ...
  list.add(ServicesModel(5, "Cleaning", "Who helps you in cleaning anything", "Cleaning", getHomeCleaning(), homeCleaner, Icons.cleaning_services_sharp));
  list.add(ServicesModel(6, "Car Cleaning", "Who helps you in cleaning the car", "Car cleaning", getHomeCleaning(), painter1, Icons.car_repair_outlined));
  list.add(ServicesModel(7, "Car Experts", "Who helps in car repairing", "Car experts", getElectricians(), electrician, Icons.home_repair_service));
  return list;
}
